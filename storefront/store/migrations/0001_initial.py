    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member_ship', models.CharField(choices=[('B', 'BROWNZ'), ('S', 'SLIVER'), ('G', 'GOLD')], default='B', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Promotions',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promotioms', models.ManyToManyField(to='store.promotions')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
            fields=[
                ...
                ('item_prize', models.DecimalField(decimal_places=2, max_digits=6)),
